...
function HomeworkViewer({ clickToClassroom, childHomework, homeworkTitle, homework, mark }) {


  return (
    <>
      <CanvasTool mark={mark} homeworkImage={homework.image} name={childHomework.name} avatar={childHomework.avatar} />
